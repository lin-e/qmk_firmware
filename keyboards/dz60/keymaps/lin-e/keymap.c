...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BL] = LAYOUT_60_iso(
	  ...
	  MO(_FL), KC_LGUI, KC_LALT, KC_SPC , KC_RALT, KC_RGUI, MO(_ML), KC_RCTL
  ),
  [_FL] = LAYOUT_60_iso(
	  KC_GRV , KC_F1  , KC_F2  , KC_F3  , KC_F4  , KC_F5  , KC_F6  , KC_F7  , KC_F8  , KC_F9  , KC_F10 , KC_F11 , KC_F12 , KC_DEL ,
	  RESET  , _______, _______, _______, _______, _______, _______, _______, KC_UP  , _______, _______, _______, _______,
